        ...
        <section className="pt-[600px] pb-16 md:pt-40  bg-white max-h-screen flex items-center">
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        Connect talented professionals with innovative companiea,
                        Your next carrer move or perfect canditate is just one click away.
                    </motion.p>
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full blur-3xl opacity-20" />
            </div>
        </section>
    )
}
