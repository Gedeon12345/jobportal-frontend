...
const JobPostingForm = () => {
    ...
    const validateForm = (formData) => {
        ...
        if (!formData.requirements.trim()) {
            errors.description = "Job requirements are required";
        }
    ...
    if (isPreview) {
        return (
            <DashboardLayout activeMenu='post-job'>
                ...
                {/* <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, necessitatibus quo maiores ex atque accusantium assumenda libero culpa natus aliquid saepe, harum inventore, nostrum eum illum porro veniam nemo dolorum! Atque dolores ipsa molestiae esse ex pariatur aliquam, eligendi tempore omnis! Nemo officia aperiam quaerat est in! Voluptatem, minus, ducimus qui ut soluta corporis aspernatur minima cupiditate omnis quas tenetur odio id. In voluptatum alias consequatur ab unde labore cupiditate odit culpa minus atque, deserunt fugit ducimus error molestias? Corrupti.</span> */}
            </DashboardLayout>
        );
    }
                    ...
                    <div className="bg-white shadow-xl rounded-2xl p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <TextareaField 
                                ...
                                helperText="Incluse key responsabilities, day-to-day taskx, and what makes this role exciting"
                                required
                            />
                            ...
                            <TextareaField
                                ...
                                error={errors.description}
                                helperText="Incluse required skills, experience level, education, and any prefernces qualifications"
                                required
                            />
                                ...
                                <div className="grid grid-cols-3 gap-3">
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className="w-full pl-5 pr-3 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 focus:border-blue-500 transition-colors duration-200"
                                        />
                                    </div>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none z-100">
                            ...
                            <div className="pt-2">
                                <button
                                    ...
                                    className="w-full flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:cursor-not-allowed outline-none cursor-pointer transition-colors duration-200"
                                >
                                    {isSubmitting ? (
                                        <>
