...
import DeleteModalPreview from "../../components/cards/DeleteModalPreview";
...
const ManageJobs = () => {
    ...
    const handleDeleteJob = async (jobId) => {
        try {
            ...
            console.error("Error deletting job :", error);
        }
    };
        ...
        try {
            ...
            if (response.status === 200 && response.data?.length > 0) {
                const formattedJobs = response.data?.map((job) => ({
                    ...
                    applicant: job?.applicationCount || 0,
                                    ...
                                    <table className="mix-w-full divide-y divide-gray-200">
                                        <thead className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                                            <tr>
                                                ...
                                                <div className="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[180px] sm:min-w-0">
                                                    Actions
                                                </div>
                                            </tr>
                                        </thead>
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            ...
                                            : paginatedJobs.map((job) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium min-w-[180px] sm:max-w-0">
                                                        <div className="flex space-x-2">
                                                            <button
                        ...
                        {totalPages > 1 && (
                            <div className="mt-6 flex items-center justify-between">
                                ...
                                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                    ...
                                    <div>
                                        <nav className="reltaive z-0 inline-flex rounded-md shadow-sm -space-x-px">
                                            <button
                                                onClick={() =>
