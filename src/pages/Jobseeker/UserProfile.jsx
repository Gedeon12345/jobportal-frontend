...
const UserProfile = () => {
    ...
    const handleImageChaneg = (e, type) => {
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center space-x-4">
                                    <div className="relative">
                                        ...
                                        />
                                        {uploadImage?.avatar && (
                                            <div className="absolute inset-0 bg-black bg-opacity-50 rounded-full fle items-center justify-center">
                                    ...
                                    <div>
                                        <label className="block">
                                            ...
                                            <input 
                                                type="file"
                                                accept="image/*"
                                                onChange={(e) => handleImageChaneg(e, "avatar")}
                                ...
                                {user?.resume ? (
                                    <div>
                                        <label className="bloxk text-sm font-medium text-gray-300 rounded-lg mb-2">
                                            Resume
                                        </label>
                                    ...
                                    <div>
                                        <label className="block">
                                            ...
                                            <input 
                                                type="file"
                                                onChange={(e) => handleImageChaneg(e, 'resume')}
                                                className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 transition-colors" 
                                            />
                                        </label>
                                    </div>
