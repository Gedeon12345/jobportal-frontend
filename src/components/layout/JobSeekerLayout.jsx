...
import { JOBSEEKER_NAVIGATION_MENU } from "../../utils/data";
...
const JobSeekerLayout = ({activeMenu, children}) => {
        ...
        <div className="flex h-screen bg-gray-50">
            ...
            >
                ...
                <nav className="p-4 space-y-2">
                    {JOBSEEKER_NAVIGATION_MENU.map((item) => (
                        <NavigationItem 
                            key={item.id}
                            item={item}
                ...
                <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 h-16 flex items-center justify-between px-6 sticky top-0 z-30">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <ProfileDropdown
                            ...
                            userRole={capitalizeFirstLetter(user?.role || "")}
                            email={user?.email || ""}
