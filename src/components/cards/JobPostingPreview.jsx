...
const JobPostingPreview = ({formData, setIsPreview}) => {
    const { user } = useAuth();
    const currencies = [{ value: 'Franc CFA', label: "FCFA" }];

    // console.log(formData.salaryMin);

    return (
        <div className="max-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 backdrop:blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl px-6 pt-6">
                    ...
                    <div className="">
                        ...
                        <div className="px-0 pb-8 space-y-8">
                            {/* Salary Section */}
                            <div className="relative overflow-hidden bg-gradient-to-r from-emerald-50 to-teal-50  border-b-emerald-100 p-6 rounded-2xl">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            <div className="p-3 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl">
                                                <span className="h-4 md:h-6 w-4 md:w-6 text-white">FCFA</span>
                                            </div>
                                            <div>
